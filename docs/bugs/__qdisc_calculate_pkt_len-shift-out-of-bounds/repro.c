...
uint64_t r[6] = {0xffffffffffffffff, 0x0, 0xffffffffffffffff, 0xffffffffffffffff, 0x0, 0xffffffffffffffff};
...
memcpy((void*)0x20000082, "", 126);
...
*(uint16_t*)0x20000268 = 0x1c;
*(uint16_t*)0x2000026a = 1;
*(uint8_t*)0x2000026c = 0;
*(uint8_t*)0x2000026d = 0xf7;
...
*(uint8_t*)0x2000028d = 6;
*(uint16_t*)0x20000290 = 0xb;
*(uint16_t*)0x20000292 = 1;
memcpy((void*)0x20000294, "clsact\000", 7);
*(uint64_t*)0x20000788 = 0x5c;
*(uint64_t*)0x20000158 = 1;
*(uint64_t*)0x20000160 = 0;
*(uint64_t*)0x20000168 = 0;
*(uint32_t*)0x20000170 = 0;
	syscall(__NR_sendmsg, r[5], 0x20000140ul, 0x10ul);
